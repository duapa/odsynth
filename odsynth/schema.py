...
from .globals import (DOM_ROOT_KEY, SCHEMA_ARRAY_TYPE_MARKER,
                      SCHEMA_MAX_COUNT_KEY, SCHEMA_PROVIDER_ARGS_KEY,
                      SCHEMA_PROVIDER_KEY, SCHEMA_SUB_FIELDS_KEY)
...
class Schema:
    ...
    def build_generator(
        self, num_examples: int = 10, batch_size: int = 10, formatter: str = None
    ) -> Schema:
        self._formatter = FormatterFactory.get_formatter(
            formatter, object_model=self._object_model
        )
